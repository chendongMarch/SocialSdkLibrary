...
> 最新版本(0.0.8)   Easier 、Lighter 、 More Business-Oriented
...
<img  style="margin-right:20px;height:20px"  src="https://img.shields.io/badge/version-0.0.8-blue.svg?maxAge=2592000"/>
...
buildscript {
    ...
    dependencies {
        // 请查看文初最新版本，这边可能忘记更新！！！
        classpath 'com.zfy.social:social-sdk-plugin:0.0.8'
    }
}
