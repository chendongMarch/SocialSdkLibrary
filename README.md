...
[SocialSdk GitHub 地址](https://github.com/chendongMarch/SocialSdkLibrary) GitHub 上面只是提供了一个 `module`，我是在另外一个工程中进行测试，因为登录功能需要成为微信开发者，需要交钱，所以当前工程并没有测试代码，后面会补充，建议下载 `module` 依赖到自己工程中使用。

[使用详细说明的博客地址](http://cdevlab.top/article/3067853428/)
